...
public class FlowProcessingStrategyConfigTestCase extends AbstractIntegrationTestCase {
  ...
  public void testDefault() throws Exception {
    assertThat(getFlowProcessingStrategy("defaultFlow").getClass().getName(),
               equalTo("org.mule.runtime.core.internal.processor.strategy.TransactionAwareProactorStreamWorkQueueProcessingStrategyFactory$TransactionAwareProactorStreamWorkQueueProcessingStrategy"));
  }
