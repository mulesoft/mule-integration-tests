...
public class LazyInitCustomPropertiesResolverExtensionTestCase extends AbstractIntegrationTestCase {
  ...
  public LazyInitCustomPropertiesResolverExtensionTestCase(String configFile) {
  ...
  public void usePlaceholder() throws Exception {
    lazyComponentInitializer.initializeComponents(componentLocation -> {
      ...
      return location.equals("usePlaceholder");
    });
  ...
  public void usePFunction() throws Exception {
    lazyComponentInitializer.initializeComponents(componentLocation -> {
      String location = componentLocation.getLocation();
      return location.equals("usePFunction");
    });
