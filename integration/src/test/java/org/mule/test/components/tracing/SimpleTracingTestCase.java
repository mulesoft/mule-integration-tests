...
public class SimpleTracingTestCase extends AbstractIntegrationTestCase {
  ...
  public void testSimpleFlow() throws Exception {
    ...
    getExportedSpansVerifier(EXPECTED_FLOW_SPAN_NAME)
        ...
        .withChildExportedSpanVerifier(getExportedSpansVerifier(EXPECTED_TRACING_CORRELATION_ID_SPAN_NAME)
            .withAttribute(LOCATION_KEY, TRACING_SET_CORRELATION_ID_LOCATION)
            .withChildExportedSpanVerifier(getExportedSpansVerifier(EXPECTED_SET_VARIABLE_SPAN_NAME)
                .withAttribute(LOCATION_KEY, SET_VARIABLE_LOCATION)
                .withAttribute(CORRELATION_ID_KEY, CORRELATION_ID_CUSTOM_VALUE)))
        .withChildExportedSpanVerifier(getExportedSpansVerifier(EXPECTED_SET_LOGGING_VARIABLE_SPAN_NAME)
            .withAttribute(LOCATION_KEY, SET_LOGGGING_VARIABLE_LOCATION))
        .withChildExportedSpanVerifier(getExportedSpansVerifier(EXPECTED_SET_PAYLOAD_SPAN_NAME)
