...
public class AsyncSuccessSpanHierarchyTestCase extends AbstractIntegrationTestCase {
  ...
  public static final String EXPECTED_ROUTE_SPAN_NAME = "mule:async:route";
  ...
  public void testAsyncFlow() throws Exception {
    ...
    try {
      ...
      SpanTestHierarchy spanTestHierarchy = new SpanTestHierarchy();
      ...
      assertThat(muleRouteSpanList.get(0).getParentSpanId(), equalTo(asyncSpan.getSpanId()));
      ...
      assertThat(setPayloadSpan.getParentSpanId(), equalTo(muleRouteSpanList.get(0).getSpanId()));
