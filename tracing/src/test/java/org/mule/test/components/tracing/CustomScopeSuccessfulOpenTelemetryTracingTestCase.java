...
public class CustomScopeSuccessfulOpenTelemetryTracingTestCase extends OpenTelemetryTracingSnifferTestCase
  ...
  public CustomScopeSuccessfulOpenTelemetryTracingTestCase(String tracingLevel, int expectedSpansCount,
