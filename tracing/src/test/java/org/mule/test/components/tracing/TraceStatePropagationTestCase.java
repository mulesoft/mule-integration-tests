...
public class TraceStatePropagationTestCase extends
  ...
  public TraceStatePropagationTestCase(String type, String path, String traceLevel, int expectedSpansCount,
  ...
  public void traceStatePropagation() throws Exception {
    ...
    headers.put("tracestate", "key1=value1,key2=value2");
