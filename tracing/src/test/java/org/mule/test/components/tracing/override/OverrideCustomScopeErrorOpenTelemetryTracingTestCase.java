...
public class OverrideCustomScopeErrorOpenTelemetryTracingTestCase extends OpenTelemetryTracingSnifferTestCase
    implements OpenTelemetryTracingTestRunnerConfigAnnotation {

  private static final int TIMEOUT_MILLIS = 30000;
  private static final int POLL_DELAY_MILLIS = 100;
  private static final String CONFIG_FILE = "tracing/custom-scope-error.xml";
  ...
  private static final String RAISE_ERROR_LOCATION = "custom-scope-flow/processors/0/processors/1";
  private static final String TEST_ARTIFACT_ID = "OverrideCustomScopeErrorOpenTelemetryTracingTestCase#testFlow";
  ...
  public static Collection<Object[]> data() {
    return asList(new Object[][] {
        {"overview-custom-scope-debug", 8, getOverviewCustomScopeDebugExpectedSpanTestHierarchy()},
        {"overview-custom-scope-monitoring", 4, getOverviewCustomScopeMonitoringExpectedSpanTestHierarchy()},
        {"monitoring-custom-scope-debug", 9, getMonitoringCustomScopeDebugExpectedSpanTestHierarchy()},
        {"monitoring-custom-scope-overview", 2, getMonitoringCustomScopeOverviewExpectedSpanTestHierarchy()},
        {"debug-custom-scope-monitoring", 5, getDebugCustomScopeMonitoringExpectedSpanTestHierarchy()},
        {"debug-custom-scope-overview", 2, getDebugCustomScopeOverviewExpectedSpanTestHierarchy()}
    });
  }

  public OverrideCustomScopeErrorOpenTelemetryTracingTestCase(String tracingLevelConf, int expectedSpansCount,
  ...
  private static BiFunction<Collection<CapturedExportedSpan>, String, SpanTestHierarchy> getOverviewCustomScopeDebugExpectedSpanTestHierarchy() {
    return (exportedSpans, artifactId) -> {
      ...
      expectedSpanHierarchy.withRoot(EXPECTED_FLOW_SPAN_NAME).addExceptionData(ANY_EXPECTED_ERROR_TYPE)
          ...
          .beginChildren()
          .child(EXPECTED_CUSTOM_SCOPE_SPAN_NAME).addExceptionData(ANY_EXPECTED_ERROR_TYPE)
