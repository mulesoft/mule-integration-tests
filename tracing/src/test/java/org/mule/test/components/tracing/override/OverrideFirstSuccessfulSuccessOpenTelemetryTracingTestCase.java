...
public class OverrideFirstSuccessfulSuccessOpenTelemetryTracingTestCase extends OpenTelemetryTracingSnifferTestCase
  ...
  public static Collection<Object[]> data() {
    return asList(new Object[][] {
        {"overview-first-successful-debug", 5, getOverviewFirstSuccessfulDebugExpectedSpanTestHierarchy()},
        {"overview-first-successful-monitoring", 5, getOverviewFirstSuccessfulMonitoringExpectedSpanTestHierarchy()},
        {"monitoring-first-successful-debug", 7, getMonitoringFirstSuccessfulDebugExpectedSpanTestHierarchy()},
        {"monitoring-first-successful-overview", 3, getMonitoringFirstSuccessfulOverviewExpectedSpanTestHierarchy()},
        {"debug-first-successful-monitoring", 7, getDebugFirstSuccessfulMonitoringExpectedSpanTestHierarchy()},
        {"debug-first-successful-overview", 3, getDebugFirstSuccessfulOverviewExpectedSpanTestHierarchy()}
    });
  }

  public OverrideFirstSuccessfulSuccessOpenTelemetryTracingTestCase(String tracingLevelConf, int expectedSpansCount,
