...
public class FirstSuccessfulSuccessOpenTelemetryTracingTestCase extends OpenTelemetryTracingSnifferTestCase
  ...
  public FirstSuccessfulSuccessOpenTelemetryTracingTestCase(String traceLevel, int expectedSpans,
