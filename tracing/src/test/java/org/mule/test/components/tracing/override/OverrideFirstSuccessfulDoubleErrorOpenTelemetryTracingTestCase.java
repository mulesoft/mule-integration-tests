...
public class OverrideFirstSuccessfulDoubleErrorOpenTelemetryTracingTestCase extends OpenTelemetryTracingSnifferTestCase
    implements OpenTelemetryTracingTestRunnerConfigAnnotation {

  private static final int TIMEOUT_MILLIS = 30000;
  private static final int POLL_DELAY_MILLIS = 100;
  private static final String CONFIG_FILE = "tracing/first-successful-double-error.xml";
  ...
  public static Collection<Object[]> data() {
    return asList(new Object[][] {
        {"overview-first-successful-debug", 9, getOverviewFirstSuccessfulDebugExpectedSpanTestHierarchy()},
        {"overview-first-successful-monitoring", 9, getOverviewFirstSuccessfulMonitoringExpectedSpanTestHierarchy()},
        {"monitoring-first-successful-debug", 11, getMonitoringFirstSuccessfulDebugExpectedSpanTestHierarchy()},
        {"monitoring-first-successful-overview", 3, getMonitoringFirstSuccessfulOverviewExpectedSpanTestHierarchy()},
        {"debug-first-successful-monitoring", 11, getDebugFirstSuccessfulMonitoringExpectedSpanTestHierarchy()},
        {"debug-first-successful-overview", 3, getDebugFirstSuccessfulOverviewExpectedSpanTestHierarchy()}
    });
  }

  public OverrideFirstSuccessfulDoubleErrorOpenTelemetryTracingTestCase(String tracingLevelConf, int expectedSpansCount,
  ...
  private static Function<Collection<CapturedExportedSpan>, SpanTestHierarchy> getOverviewFirstSuccessfulDebugExpectedSpanTestHierarchy() {
    return exportedSpans -> {
      ...
      expectedSpanHierarchy.withRoot(EXPECTED_FLOW_SPAN_NAME).addExceptionData(ANY_EXPECTED_ERROR_TYPE)
          ...
          .beginChildren()
          .child(EXPECTED_FIRST_SUCCESSFUL_SPAN_NAME).addExceptionData(ANY_EXPECTED_ERROR_TYPE)
          .addAttributesToAssertExistence(attributesToAssertExistence)
          .beginChildren()
          ...
          .addAttributesToAssertExistence(attributesToAssertExistence)
          .endChildren()
          .child(EXPECTED_ROUTE_SPAN_NAME_ATTEMPT_2).addExceptionData(ANY_EXPECTED_ERROR_TYPE)
          .addAttributesToAssertExistence(attributesToAssertExistence)
          .beginChildren()
          .child(EXPECTED_SET_PAYLOAD_SPAN_NAME)
          .addAttributesToAssertExistence(attributesToAssertExistence)
