...
public class ForEachErrorOpenTelemetryTracingTestCase extends OpenTelemetryTracingSnifferTestCase
  ...
  public static Collection<Object[]> data() {
    return asList(new Object[][] {
        ...
        {MONITORING.name(), 7, getMonitoringExpectedSpanTestHierarchy()},
        {DEBUG.name(), 7, getDebugExpectedSpanTestHierarchy()}
    });
  }
  ...
  private static Function<Collection<CapturedExportedSpan>, SpanTestHierarchy> getMonitoringExpectedSpanTestHierarchy() {
    return exportedSpans -> {
      ...
      expectedSpanHierarchy.withRoot(EXPECTED_FLOW_SPAN_NAME).addExceptionData("ANY:EXPECTED")
          ...
          .child(EXPECTED_FOREACH_SPAN_NAME).addExceptionData("ANY:EXPECTED")
          .beginChildren()
  ...
  public ForEachErrorOpenTelemetryTracingTestCase(String traceLevel, int expectedSpansCount,
