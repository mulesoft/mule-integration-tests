...
public class OverrideScatterGatherDoubleErrorOpenTelemetryTracingTestCase extends OpenTelemetryTracingSnifferTestCase
  ...
  public OverrideScatterGatherDoubleErrorOpenTelemetryTracingTestCase(String tracingLevelConf, int expectedSpansCount,
