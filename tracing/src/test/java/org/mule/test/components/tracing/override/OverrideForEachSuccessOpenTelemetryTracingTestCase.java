...
public class OverrideForEachSuccessOpenTelemetryTracingTestCase extends OpenTelemetryTracingSnifferTestCase
    implements OpenTelemetryTracingTestRunnerConfigAnnotation {

  private static final int TIMEOUT_MILLIS = 30000;
  private static final int POLL_DELAY_MILLIS = 100;
  private static final String CONFIG_FILE = "tracing/foreach-success.xml";
  ...
  public static Collection<Object[]> data() {
    return asList(new Object[][] {
        {"overview-foreach-debug", 11, getOverviewForeachDebugExpectedSpanTestHierarchy()},
        {"overview-foreach-monitoring", 11, getOverviewForeachMonitoringExpectedSpanTestHierarchy()},
        {"monitoring-foreach-debug", 13, getMonitoringForeachDebugExpectedSpanTestHierarchy()},
        {"monitoring-foreach-overview", 3, getMonitoringForeachOverviewExpectedSpanTestHierarchy()},
        {"debug-foreach-monitoring", 13, getDebugForeachMonitoringExpectedSpanTestHierarchy()},
        {"debug-foreach-overview", 3, getDebugForeachOverviewExpectedSpanTestHierarchy()}
    });
  }

  public OverrideForEachSuccessOpenTelemetryTracingTestCase(String tracingLevelConf, int expectedSpansCount,
