...
public class OverrideParallelForEachSuccessOpenTelemetryTracingTestCase extends OpenTelemetryTracingSnifferTestCase
  ...
  public OverrideParallelForEachSuccessOpenTelemetryTracingTestCase(String traceLevel, int expectedSpansCount,
