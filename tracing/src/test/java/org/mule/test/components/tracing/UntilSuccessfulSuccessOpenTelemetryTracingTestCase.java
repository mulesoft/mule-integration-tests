...
public class UntilSuccessfulSuccessOpenTelemetryTracingTestCase extends OpenTelemetryTracingSnifferTestCase
  ...
  public UntilSuccessfulSuccessOpenTelemetryTracingTestCase(String traceLevel, int expectedSpans,
